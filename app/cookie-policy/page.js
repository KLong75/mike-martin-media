export const metadata = {
  title: "Cookie Policy",
  description: "Cookie policy for mikemartinmedia.com",
  alternates: {
  ...
  return (
    <main className="p-6 flex flex-col items-center justify-center">
      <div className="lg:max-w-400 ">
        ...
        <p>
          <strong>
            The Cloudfare and Calendly cookies in necessary cookies come from
            Vimeo where our videos are hosted.
          </strong>
        </p>
        &nbsp;
        ...
        <div>
          ...
          <p className="p-2">
            If you are using any other web browser, please visit their official
            support documents.
          </p>
        </div>
        &nbsp;
        <p className="cookie-policy-p p-2">
          Cookie Policy Generated By: <br />
          <a
