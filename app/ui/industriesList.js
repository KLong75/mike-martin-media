  ...
  return (
    <div className="text-white">
     <h6 className="text-xl mb-10 relative">
       Industries
       <span className="absolute bottom-[-1rem] left-0 w-[calc(100%+4rem)] xl:w-[calc(100%+6rem)] border-b border-white border-2"></span>
     </h6>
     ...
     {industries.map((industry, index) => (
        <li key={index} className="relative">
          ...
          <span className="absolute bottom-[-.5rem] left-0 w-[calc(100%+4rem)] xl:w-[calc(100%+6rem)] border-b border-white"></span>
        </li>
      ))}
      </ul>
    </div>
