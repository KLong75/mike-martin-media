...
export default function Header() {
  return (
    <header className="flex items-center bg-black text-white h-30 lg:h-32 3xl:h-40">
      <div className="ml-2 sm:ml-6 md:ml-12 2xl:ml-20 w-40 md:w-42 lg:w-48 xl:w-52 3xl:w-64 h-auto p-2">
