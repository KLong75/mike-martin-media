  ...
  return (
    <div className="relative w-full h-full overflow-hidden group">
      <Link href={href}>
        ...
        <div className="capability-label text-sm sm:text-lg md:text-xl lg:text-2xl 3xl:text-3xl font-bold absolute bottom-[2.5rem] lg:bottom-[6rem] left-[-1.25rem] z-50 text-white transform -rotate-90">
          <span>{label}</span>
        </div>
      </Link>
    </div>
