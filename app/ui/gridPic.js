  ...
  return (
    <div className="relative w-full h-full overflow-hidden group">
      <Link href={href}>
        ...
        <div className="capability-label text-sm sm:text-lg md:text-xl lg:text-2xl 3xl:text-3xl font-bold absolute bottom-0 xl:bottom-[1rem] left-[1.5rem] xl:left-[2.5rem] text-white transform -rotate-90 origin-left">
          <span>{label}</span>
        </div>
      </Link>
    </div>
