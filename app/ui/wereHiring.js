    ...
    <div className="flex flex-col justify-center items-center h-full">
      <div className="flex flex-col justify-center p-12 items-center">
        ...
        <a
          ...
          <Image
            className="w-3/5 lg:w-9/12 rounded-lg hover:shadow-2xl transorm hover:scale-105 transition duration-300 ease-in-out"
        ...
        <p className="text-center text-xl 2xl:text-2xl p-2"> Apply on ZipRecruiter</p>
      </div>
    </div>
  );
}
