  ...
  return (
    <>
      <main>
        ...
        <div className="md:text-lg xl:text-xl 3xl:text-3xl flex justify-center items-center mt-4">
          <p className="p-2 text-center text-balance w-10/12 md:w-1/2">
            Elevate your brand with our dynamic animation and motion graphics
            capabilities. From captivating 2D illustrations to immersive 3D
            experiences, we bring your vision to life with creativity and
            precision.
          </p>
        </div>
