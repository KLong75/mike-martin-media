...
export function middleware(request) {
  ...
  const previewCspHeader = `
    ...
    script-src-elem 'self' 'nonce-${nonce}' https://cdn.lightwidget.com/widgets/lightwidget.js https://www.googletagmanager.com/gtm.js https://googletagmanager.com/* https://mmmmarketing42.activehosted.com/f/embed.php?id=1;
