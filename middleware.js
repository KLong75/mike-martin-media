...
export function middleware(request) {
  ...
  const previewCspHeader = `
    ...
    connect-src 'self' *.cookieyes.com cdn-cookieyes.com https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com www.googletagmanager.com https://marketing42.activehosted.com/proc.php ws://127.0.0.1:50820/;
    font-src 'self' data:;
    object-src 'none';
    base-uri 'self';
    form-action 'self';
