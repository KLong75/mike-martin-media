...
export function middleware(request) {
  ...
  const developmentCspHeader = `
    default-src 'self';
    script-src 'self' 'nonce-${nonce}' 'strict-dynamic' 'unsafe-eval' https://mmmmarketing42.activehosted.com/ https://*.googletagmanager.com;
    style-src 'self' 'unsafe-inline' https://fonts.bunny.net/css;
    img-src 'self' blob: data: https://d226aj4ao1t61q.cloudfront.net/esfkyjh1u_forms-close-dark.png https://www.google.com/pagead/ https://*.google-analytics.com https://*.googletagmanager.com;
  ...
  const previewCspHeader = `
    ...
    script-src-elem 'self' 'nonce-${nonce}'  https://www.googletagmanager.com/gtm.js https://googletagmanager.com/* https://mmmmarketing42.activehosted.com/ https://prism.app-us1.com/ https://cdn-cookieyes.com/ https://*.googletagmanager.com;
    style-src 'self' 'unsafe-inline' https://fonts.bunny.net/css;
    img-src 'self' blob: data: https://i.vimeocdn.com/video/* https://www.googletagmanager.com/ https://d226aj4ao1t61q.cloudfront.net/esfkyjh1u_forms-close-dark.png https://www.google.com/pagead/ https://*.google-analytics.com https://*.googletagmanager.com;
  ...
  const productionCspHeader = `
    ...
    style-src 'self' 'unsafe-inline' https://fonts.bunny.net/css;
    img-src 'self' blob: data: https://i.vimeocdn.com/video/* https://cdn-cookieyes.com/assets/images/close.svg https://cdn-cookieyes.com/assets/images/poweredbtcky.svg cdn-cookieyes.com https://d226aj4ao1t61q.cloudfront.net/esfkyjh1u_forms-close-dark.png https://www.googletagmanager.com/td https://www.googletagmanager.com/a https://www.google.com/pagead/ https://*.google-analytics.com https://*.googletagmanager.com;
