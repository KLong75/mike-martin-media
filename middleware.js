...
export function middleware(request) {
  ...
  const previewCspHeader = `
    default-src 'none';
    script-src 'self' 'nonce-${nonce}' https://f.vimeocdn.com/* https://f.vimeocdn.com/js_opt/modules/utils/vuid.min.js https://f.vimeocdn.com/p/4.37.12/js/player.module.js https://player.vimeo.com/* https://*.googletagmanager.com https://mmmmarketing42.activehosted.com/ https://prism.app-us1.com/ https://cdn-cookieyes.com/ https://s.ksrndkehqnwntyxlhgto.com/136008.js;
    style-src 'self' 'unsafe-inline' https://fonts.bunny.net/css;
