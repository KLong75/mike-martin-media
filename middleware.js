...
export function middleware(request) {
  ...
  const previewCspHeader = `
    ...
    script-src-elem 'self' 'nonce-${nonce}' https://www.googletagmanager.com/gtm.js https://googletagmanager.com/* https://mmmmarketing42.activehosted.com/ https://prism.app-us1.com/ https://cdn-cookieyes.com/client_data/19a125e146c5960eee961f00/script.js;
    style-src 'self' 'unsafe-inline' https://fonts.bunny.net/css;
  ...
  const productionCspHeader = `
    ...
    script-src-elem 'self' 'nonce-${nonce}' https://www.googletagmanager.com/gtm.js https://googletagmanager.com/* https://cdn-cookieyes.com/client_data/19a125e146c5960eee961f00/banner.js https://mmmmarketing42.activehosted.com/ https://prism.app-us1.com/;
    style-src 'self' 'unsafe-inline' https://fonts.bunny.net/css;
