...
export function middleware(request) {
  ...
  const previewCspHeader = `
    ...
    script-src-elem 'self' 'nonce-${nonce}' https://cdn.lightwidget.com/widgets/lightwidget.js https://www.googletagmanager.com/gtm.js?id=GTM-5W7VWSTB https://googletagmanager.com/*;
    style-src 'self' 'nonce-${nonce}';
