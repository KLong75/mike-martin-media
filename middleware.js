...
export function middleware(request) {
  ...
  const developmentCspHeader = `
    ...
    img-src 'self' blob: data: https://d226aj4ao1t61q.cloudfront.net/esfkyjh1u_forms-close-dark.png https://www.google.com/pagead/ https://image.mux.com/ https://swiperjs.com;
    media-src 'self' blob: data: https://player.vimeo.com https://f.vimeocdn.com https://vimeo.com https://image.mux.com/ *.mux.com/;
  ...
  const previewCspHeader = `
    default-src 'none';
    script-src 'self' 'nonce-${nonce}' https://f.vimeocdn.com/* https://f.vimeocdn.com/js_opt/modules/utils/vuid.min.js https://f.vimeocdn.com/p/4.37.12/js/player.module.js https://player.vimeo.com/* https://*.googletagmanager.com https://mmmmarketing42.activehosted.com/ https://prism.app-us1.com/ https://cdn-cookieyes.com/;
    style-src 'self' 'unsafe-inline' https://fonts.bunny.net/css;
    img-src 'self' blob: data: https://i.vimeocdn.com/video/* https://www.googletagmanager.com/ https://d226aj4ao1t61q.cloudfront.net/esfkyjh1u_forms-close-dark.png https://www.google.com/pagead/ https://image.mux.com/;
    media-src 'self' blob: data: https://player.vimeo.com https://f.vimeocdn.com https://vimeo.com https://i.vimeocdn.com/video/* https://player.vimeo.com/video/* *.mux.com/;
    connect-src 'self' https://stats.g.doubleclick.net https://analytics.google.com *.cookieyes.com cdn-cookieyes.com https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com www.googletagmanager.com https://mmmmarketing42.activehosted.com/proc.php https://process.iconnode.com/google-ads/ https://*.ksrndkehqnwntyxlhgto.com https://www.google-analytics.com https://stats.g.doubleclick.net https://www.google.com https://google.com https://inferred.litix.io/ *.mux.com/;
    font-src 'self' data: https://fonts.bunny.net/;
    object-src 'none';
    base-uri 'self';
    form-action 'self';
  ...
  const productionCspHeader = `
    ...
    img-src 'self' blob: data: https://i.vimeocdn.com/ https://i.vimeocdn.com/video/* https://cdn-cookieyes.com/assets/images/close.svg https://cdn-cookieyes.com/assets/images/poweredbtcky.svg cdn-cookieyes.com https://d226aj4ao1t61q.cloudfront.net/esfkyjh1u_forms-close-dark.png https://www.googletagmanager.com/td https://www.googletagmanager.com/a https://www.google.com/pagead/ https://*.google-analytics.com https://*.googletagmanager.com fonts.gstatic.com https://image.mux.com/;
    media-src 'self' blob: data: https://player.vimeo.com https://f.vimeocdn.com https://vimeo.com https://i.vimeocdn.com/video/* https://player.vimeo.com/video/* https://scontent-hel3-1.cdninstagram.com/o1/ *.mux.com/;
    connect-src 'self' 'nonce-${nonce}' https://analytics.google.com *.cookieyes.com cdn-cookieyes.com https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com www.googletagmanager.com https://mmmmarketing42.activehosted.com/proc.php https://process.iconnode.com/google-ads/ https://*.ksrndkehqnwntyxlhgto.com https://www.google-analytics.com https://stats.g.doubleclick.net https://www.google.com https://google.com https://pagead2.googlesyndication.com https://inferred.litix.io/ *.mux.com/;
    font-src 'self' data: https://fonts.bunny.net/; 
    object-src 'none';
    base-uri 'self';
    form-action 'self';
